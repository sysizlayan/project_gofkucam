//$file${../../include/qm~::DetectorController.hpp} vvvvvvvvvvvvvvvvvvvvvvvvvv
//
// Model: gofkucam.qm
// File:  ${../../include/qm~::DetectorController.hpp}
//
...
//
//$endhead${../../include/qm~::DetectorController.hpp} ^^^^^^^^^^^^^^^^^^^^^^^
#ifndef DETECTOR_CONTROLLER_HPP_
...
//$declare${Components::DetectorController} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv

//${Components::DetectorController} ..........................................
class DetectorController : public QP::QActive {
private:
